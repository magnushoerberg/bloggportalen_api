...
class Twingly_Configuration extends Twingly
{
    /**
     * Twingly API version to use
     * @access public
     */
    const API_VERSION =  1;
     ...
     * @throws Twingly_Exception_Configuration
     * @static
     * @return boolean
     */
    private static function validate($key=null, $value=null)
    {
        ...
        if ($key === 'environment' &&
            !in_array($value, self::$_validEnvironments) ) {
                throw new Twingly_Exception_Configuration('"' .
                    $value . '" is not a valid environment.');
            }

        if (!isset(self::$_cache[$key])) {
            throw new Twingly_Exception_Configuration($key .
    ...
    public static function twinglyId($value = null)
    {
        return self::setOrGet(__FUNCTION__, $value);
    }

    public static function twinglyApiKey($value = null)
    {
        return self::setOrGet(__FUNCTION__, $value);
    }
    ...
    public static function topListUrl()
    {
        return self::baseUrl() .
               self::topListPath();
    }

    public static function topListPath()
    {
        return '/top-list';
    }
    ...
    public static function caFile($sslPath = NULL)
    {
        ...
        {
            throw new Twingly_Exception_SSLCaFileNotFound();
        }
    ...
    public static function portNumber()
    {
        ...
        return getenv("GATEWAY_PORT") ? getenv("GATEWAY_PORT") : 8888;
    }
    ...
    public static function serverName()
    {
        switch(self::environment()) {
        case 'production':
            $serverName = 'api.bloggportalen.se';
            break;
        case 'development':
        default:
